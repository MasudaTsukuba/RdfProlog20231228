...
def test_answer_question4b_add_2_ans_3():
    ...
    my_question = \
        ...
        f'}}'
    my_sparql_query = ClassSparqlQuery().set(my_question).build_rule()
    resolve_bindings = rdf_prolog.answer_complex_question(my_sparql_query, max_depth=10)
...
def test_add_9_y_z():
    ...
    my_question = \
        ...
        f'?s <http://example.org/variable_y> ?yy . ' \
        f'?s <http://example.org/variable_z> ?z . ' \
        f'}}'
    my_sparql_query = ClassSparqlQuery().set(my_question).build_rule()
    resolve_bindings = rdf_prolog.answer_complex_question(my_sparql_query, find_all=True, max_depth=20)
    assert resolve_bindings[0]['?yy'] == f'<http://example.org/one>'
...
def test_add_x_y_3():
    ...
    my_question = \
        ...
        f'}}'
    my_sparql_query = ClassSparqlQuery().set(my_question).build_rule()
    resolve_bindings = rdf_prolog.answer_complex_question(my_sparql_query, find_all=True, max_depth=10)
